...
# load
file_path = '/DM/站點分群_共用/[txn]ubike_202211_agg_by_stop_weekday_hour.csv'
ubike_byweekday = pd.read_csv(root_path+file_path)
...
# save
file_path = '/DM/站點分群_嚴格/[txn]202211_by_weekday_by_period.csv'
...
# save
file_path = '/DM/站點分群_嚴格/[PBI][txn]kmean_label_by_weekday_by_period.csv'
