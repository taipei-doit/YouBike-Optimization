...
# load txn
txn = pd.read_csv(root_path+'/DM/output_for_roy/202211.csv')
...
# save
file_path = '/DM/站點潛在需求/[txn]potential_demand_idlist.pickle'
...
# save
file_path = '/DM/站點潛在需求/[txn]potential_demand_count_by_weekday_type_by_hour.csv'
potential_demand_count_df.to_csv(root_path+file_path, index=False, encoding='utf8')
