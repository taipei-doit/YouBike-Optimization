# -*- coding: utf-8 -*-
"""
Created on Wed Oct 18 22:28:43 2023
...
exec(open(f'D:\\iima/ubike分析/CODE/{ym}/閒置車'+"/output_index_date_stop.py", encoding='UTF-8').read())
exec(open(f'D:\\iima/ubike分析/CODE/{ym}/閒置車'+"/output_weekday_type_std_for_pbi.py", encoding='UTF-8').read())
